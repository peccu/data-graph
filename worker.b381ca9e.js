...
},{}],"src/js/storage-driver/backend/isomorphic-git/worker.js":[function(require,module,exports) {
"use strict";
...
importScripts('https://isomorphic-git.org/js/browserfs.js', 'https://isomorphic-git.org/js/pify.js', 'https://unpkg.com/isomorphic-git', 'https://unpkg.com/magic-portal');
var fsOptions = {
  fs: 'IndexedDB',
  options: {}
};
BrowserFS.configure(fsOptions,
/*#__PURE__*/
function () {
  var _ref = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(err) {
    var portal, fs, emitter, credentialManager;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            portal = new MagicPortal(self); // Initialize isomorphic-git

            fs = BrowserFS.BFSRequire('fs');
            portal.set('fs', fs);
            portal.set('pfs', pify(fs)); // Initialize isomorphic-git with our new file system

            git.plugins.set('fs', fs);
            _context.next = 9;
            return portal.get('emitter');

          case 9:
            emitter = _context.sent;
            git.plugins.set('emitter', emitter);
            _context.next = 13;
            return portal.get('credentialManager');

          case 13:
            credentialManager = _context.sent;
            git.plugins.set('credentialManager', credentialManager);
            fs.getRootFS().empty(function () {
              fs.mkdir('/', function () {
                portal.set('git', git);
              });
            });
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/js/storage-driver/backend/isomorphic-git/worker.js"], null)
//# sourceMappingURL=/worker.b381ca9e.map